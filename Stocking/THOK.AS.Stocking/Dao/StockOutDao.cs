    ...
    public class StockOutDao: BaseDao
    {
        ...
        public DataTable FindAll()
        {
            string sql = " SELECT A.STOCKOUTID,A.LINECODE,A.CIGARETTECODE,A.CIGARETTENAME,D.CHANNELNAME AS SORT_CHANNELNAME," +
                            " CASE WHEN A.STATE=1 THEN '“—∑¢ÀÕ' ELSE 'Œ¥∑¢ÀÕ' END STATE," +
                            " CASE WHEN SCAN_STATE_02 ='1' THEN '“—…®√Ë' ELSE 'Œ¥…®√Ë' END ISSCAN02, " +
                            " CASE WHEN SCAN_STATE_03 ='1' THEN '“—…®√Ë' ELSE 'Œ¥…®√Ë' END ISSCAN03, " +
                            " CASE WHEN SCAN_STATE_04 ='1' THEN '“—…®√Ë' ELSE 'Œ¥…®√Ë' END ISSCAN04, " +
                            " CASE WHEN SCAN_STATE_05 ='1' THEN '“—…®√Ë' ELSE 'Œ¥…®√Ë' END ISSCAN05, " +
